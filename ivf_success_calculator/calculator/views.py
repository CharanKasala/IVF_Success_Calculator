...
def index(request):
    ...
    if request.method == 'POST':
        ...
        if(filtered_data.empty):
            ...
            error_message= "No matching data found for given input"
        ...
        return redirect(f'/success/?success_rate={success_rate * 100}')
    
    return render(request, 'calculator/index.html')

def success_view (request):
    success_rate=request.GET.get('success_rate',None)
    ...
    return render(request,'calculator/success.html',{'success_rate': success_rate,'error_message': error_message,})